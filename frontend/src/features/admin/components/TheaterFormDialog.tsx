  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent size="lg" className="bg-[#201b11] border-[#3f382d] text-white rounded-2xl">
        <DialogHeader>
          <DialogTitle>{isEditMode ? 'Chỉnh sửa chi nhánh' : 'Thêm chi nhánh mới'}</DialogTitle>
        </DialogHeader>
          ...
          <DialogBody>
            <div className="grid grid-cols-12 gap-4">
              <div className="col-span-4">
                ...
                {isEditMode && <p className="text-gray-500 text-xs mt-1">Không thể đổi mã chi nhánh</p>}
              </div>
              ...
              <div className="col-span-4">
                <label className="text-sm text-gray-400 mb-1.5 block">Vĩ độ (latitude)</label>
                <Input type="number" step="0.000001" {...register('latitude')} placeholder="21.028511" />
              </div>
              <div className="col-span-4">
                <label className="text-sm text-gray-400 mb-1.5 block">Kinh độ (longitude)</label>
                <Input type="number" step="0.000001" {...register('longitude')} placeholder="105.804817" />
              </div>
              <div className="col-span-4">
